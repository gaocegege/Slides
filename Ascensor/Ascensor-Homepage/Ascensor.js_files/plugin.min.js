...
function(e, t, n, o) {
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
        ...
        init: function() {
            ...
            }, this.node = e(this.element), this.nodeChildren = this.node.children(this.options.childType), this.floorActive = l(this._getFloorFromHash()) ? this._getFloorFromHash() : this.options.windowsOn, this.NH = this.node.height(), this.NW = this.node.width(), this.directionIsArray = u(this.options.direction), this.supportTransform = i(), u(this.options.ascensorFloorName) && this.options.ascensorFloorName.length < this.nodeChildren.length ? this._emitConsoleMessage("error", "floors total (" + this.nodeChildren.length + ") & floor name array length (" + this.options.ascensorFloorName.length + ") don't match") : this.directionIsArray && this.options.direction.length < this.nodeChildren.length ? this._emitConsoleMessage("error", "floors total (" + this.nodeChildren.length + ") & direction array lenght (" + this.options.direction.length + ") don't match") : (this.setup(), o)
        },
        setup: function() {
            this._positionElement(), this._bindEvents(), this.scrollToFloor(this.floorActive), u(this.options.ascensorFloorName) && this._updateHash(this.floorActive), c(this.options.ready) && this.options.ready()
        },
        _bindEvents: function() {
            ...
            if (this.node.on("scrollToDirection", function(e, t) {
                ...
                if ("string" == typeof n) {
                    var o = e.inArray(n, r.options.ascensorFloorName); - 1 !== o && r.scrollToFloor(o)
            ...
            }), u(this.options.ascensorFloorName) && e(t).on("hashchange.ascensor", function(e) {
                r._hashchangeHandler(e)
            }), t.DeviceOrientationEvent && e(t).on("orientationchange.ascensor", function() {
                r.scrollToFloor(r.floorActive)
            }), this.options.keyNavigation && e(n).on("keydown.ascensor", function(e) {
                r._keypressHandler(e)
            }), this.options.swipeNavigation) {
                var i = "touchstart.ascensor touchend.ascensor";
                "mobile-only" !== this.options.swipeNavigation && (i += " mousedown.ascensor mouseup.ascensor"), this.node.on(i, function(e) {
        ...
        destroy: function() {
            this.node.off("scrollToDirection scrollToStage next prev refresh remove touchstart.ascensor touchend.ascensor mousedown.ascensor mouseup.ascensor"), e(t).off("resize.ascensor hashchange.ascensor orientationchange.ascensor"), e(n).off("keydown.ascensor"), this.node.css({
                position: "",
                overflow: "",
                top: "",
                left: "",
        ...
        _getFloorFromHash: function() {
            return this._getHash() && this.options.ascensorFloorName && s(this.options.ascensorFloorName, this._getHash()) ? this.options.ascensorFloorName.indexOf(this._getHash()) : !1
        },
        _getHash: function() {
            if (t.location.hash) {
        ...
        _updateHash: function(e) {
            u(this.options.ascensorFloorName) && this._getHash() !== this.options.ascensorFloorName[e] && t.location.replace(("" + t.location).split("#")[0] + "#" + this.options.ascensorFloorName[e])
        },
        ...
        _emitConsoleMessage: function(e, t) {
            "error" == e && console.error("Ascensor.js: " + t), "warn" == e && console.warn("Ascensor.js: " + t)
        },
